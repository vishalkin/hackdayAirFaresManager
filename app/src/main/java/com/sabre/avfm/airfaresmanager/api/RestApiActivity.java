...
public class RestApiActivity extends AppCompatActivity {
    ...
    private class HttpRequestTask extends AsyncTask<Void, Void, Fare> {
        @Override
        protected Fare doInBackground(Void... params) {
            try {
        ...
        protected void onPostExecute(Fare fare) {
            ...
            greetingIdText.setText(fare.getCarrierCode());
            greetingContentText.setText(fare.getFareAmount().toString());
        }
